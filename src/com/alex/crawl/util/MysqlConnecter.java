...
public class MysqlConnecter {
    ...
    public int isExist(String tableName,String col,String val){
        String sqlSelect = "select * from "+tableName+" where "+col+"='"+val+"'";
        ArrayList<Map<String, String>> ret = select(sqlSelect,tableName);
        if(ret!=null){
            return ret.size();
        }else{
            return -1;
